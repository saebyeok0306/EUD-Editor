...
function StartScreen({ onCreateProject, onOpenProject, onOpenSettings, recentProjects = [], onOpenRecentProject }) {
  ...
  return (
    <div className="start-screen">
      ...
      <main className="start-content-wrapper">
        <div className="start-content centered">
        ...
        <aside className="recent-projects-sidebar">
          <div className="section-label">{t('start.recentMaps')}</div>
          <div className="recent-projects-list">
            {recentProjects.length > 0 ? (
              ...
              <div className="recent-empty">{t('start.recentEmpty')}</div>
            )}
          </div>
        </aside>
      </main>
