const en = {
  ...
  'unit.prop.id': 'ID',
  'unit.prop.name': 'Name',
  'unit.prop.maxHp': 'Hit Points',
  'unit.prop.maxShield': 'Shield Points',
  'unit.prop.hasShield': 'Enabled',
  'unit.prop.armor': 'Armor',
  'unit.prop.timeCost': 'Build Time',
  ...
  'unit.prop.supplyUsed': 'Supply Required',
  ...
  'unit.prop.killScore': 'Destroy Score',
  'unit.prop.broodWarFlag': 'Broodwar Unit',
  'unit.prop.maxGroundHits': 'Ground Hits',
  'unit.prop.maxAirHits': 'Air Hits',
  'unit.prop.transportSpaceRequired': 'Space Required',
  'unit.prop.transportSpaceProvided': 'Space Provided',
  'unit.prop.seekRange': 'Acquisition Range',
  'unit.prop.sizeType': 'Armor Type',
  'unit.sizeType.independent': 'Independent',
  'unit.sizeType.small': 'Small',
  'unit.sizeType.medium': 'Medium',
  'unit.sizeType.large': 'Large',
  'unit.empty.text': 'Select a Unit to view and edit its properties',

  // Unit Graphics Tab
  'unit.graphics.info': 'Graphics Info',
  'unit.graphics.flingy': 'Flingy',
  'unit.graphics.constructionGraphic': 'Construction',
  'unit.graphics.portrait': 'Portrait',
  'unit.graphics.elevation': 'Elevation',
  'unit.graphics.startDirection': 'Direction',
  'unit.graphics.unitSize': 'Unit Size',
  'unit.graphics.unitBoundsL': 'Left',
  'unit.graphics.unitBoundsR': 'Right',
  'unit.graphics.unitBoundsT': 'Up',
  'unit.graphics.unitBoundsB': 'Down',
