const ko = {
  ...
  'unit.prop.name': '이름',
  'unit.prop.maxHp': '체력',
  'unit.prop.maxShield': '실드량',
  'unit.prop.hasShield': '사용',
  'unit.prop.armor': '방어력',
  'unit.prop.timeCost': '생산 시간',
  ...
  'unit.prop.killScore': '파괴 점수',
  'unit.prop.broodWarFlag': '브루드워 유닛',
  'unit.prop.maxGroundHits': '초기 타격수(지상)',
  'unit.prop.maxAirHits': '초기 타격수(공중)',
  'unit.prop.transportSpaceRequired': '필요 공간',
  'unit.prop.transportSpaceProvided': '탑승 공간',
  'unit.prop.seekRange': '인지 거리',
  'unit.prop.sizeType': '방어 타입',
  'unit.sizeType.independent': '독립적크기',
  'unit.sizeType.small': '소형',
  'unit.sizeType.medium': '중형',
  'unit.sizeType.large': '대형',
  'unit.empty.text': '유닛을 선택하면 속성을 볼 수 있습니다',

  // Unit Graphics Tab
  'unit.graphics.info': '그래픽 정보',
  'unit.graphics.flingy': '비행정보',
  'unit.graphics.constructionGraphic': '생산모습',
  'unit.graphics.portrait': '얼굴모습',
  'unit.graphics.elevation': '높이',
  'unit.graphics.startDirection': '생산방향',
  'unit.graphics.unitSize': '유닛 크기',
  'unit.graphics.unitBoundsL': '좌',
  'unit.graphics.unitBoundsR': '우',
  'unit.graphics.unitBoundsT': '상',
  'unit.graphics.unitBoundsB': '하',
